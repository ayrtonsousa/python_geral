...
# ordem aleatória, justamente com os gabaritos contendo as respostas
#os dados das provas. As chaves são os estados e os valores são as capitais
...
#Gera 35 arquivos contendo as provas para cada aluno
for quizNum in range(35):
    ...
    quizFile.write('Nome:\n\nData:\n\nPeríodo:\n\n')
    quizFile.write(('' * 20) + 'Capitais do Estado Quiz (Form %s)' % (quizNum + 1))
    quizFile.write('\n\n')
    ...
    for questionNum in range(50):
        ...
        #Grava pergunta e as opções de resposta no arquivo da prova
