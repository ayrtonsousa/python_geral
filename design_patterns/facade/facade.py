...
class SalaoFestas:
    ...
    def _esta_disponivel(self):
        print('SalaFestas :: Este salão de festas esta disponivel?')
        return True

    def agendar(self):
        if self._esta_disponivel():
            print('SalaoFestas :: Agendamento do salão de realizado \n')
...
class Florista:
    ...
    def arranjar_flores(self):
        print('Florista :: Rosas, Tulipas e Lírios serão usados...\n')
...
class Cliente:
    ...
    def contrata_gerente_eventos(self):
        print('Cliente :: Vou contratar um empresa para gerenciar eventos\n')

        ge = GerenciadorEventos()
        ge.organizar()
    
    def __del__(self):
        print('Cliente :: Foi muito simples organizar esse evento com Façade')
